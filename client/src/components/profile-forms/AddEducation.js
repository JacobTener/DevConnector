    ...
    return (
        <Fragment>
            ...
            <form className="form" onSubmit= {e => {
                ...
                <div className="form-group">
                <p><input type="checkbox" checked={current} name="current" value={current} onChange={e => {setFormData({...formData, current: !current}); toggleDisabled(!toDateDisabled) }} />{' '} Current Education</p>
                </div>
                <div className="form-group">
                <h4>To Date</h4>
